...
class SRT {
    ...
    timestamp(t) {
        ...
        const ms = (0, padstart_1.default)(Math.floor(x % 1000), 2, '0');
        x /= 1000;
        const ss = (0, padstart_1.default)(Math.floor(x % 60), 2, '0');
        x /= 60;
        const mm = (0, padstart_1.default)(Math.floor(x % 60), 2, '0');
        x /= 60;
        const hh = (0, padstart_1.default)(Math.floor(x % 24), 2, '0');
        return `${hh}:${mm}:${ss},${ms}`;
    }
    render(tracks) {

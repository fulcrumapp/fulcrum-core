...
var DateFormatValidationError = function (_ElementValidationErr) {
  _inherits(DateFormatValidationError, _ElementValidationErr);

  function DateFormatValidationError() {
    _classCallCheck(this, DateFormatValidationError);

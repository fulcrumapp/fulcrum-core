...
class RepeatableItemValue extends feature_1.default {
    ...
    get formValues() {
        if (!this._formValues) {
            this._formValues = new form_values_1.default(this._element, this._formValuesJSON);
        }
    ...
    loadCreatedBy(dataSource, callback) {
        return (0, load_object_1.default)(this, dataSource, 'createdBy', 'getUser', callback);
    }
    loadUpdatedBy(dataSource, callback) {
        return (0, load_object_1.default)(this, dataSource, 'updatedBy', 'getUser', callback);
    }
    get changeset() {

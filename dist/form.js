...
const child_elements_1 = __importDefault(require("./elements/child-elements"));
const status_element_1 = __importDefault(require("./elements/status-element"));
const project_element_1 = __importDefault(require("./elements/project-element"));
const default_values_1 = __importDefault(require("./values/default-values"));
...
class Form {
    ...
    load(dataSource, callback) {
        ...
        async_1.default.each(loadElements, (element, cb) => {
    ...
    createRecord(attributes) {
        const record = new record_1.default(attributes, this);
        default_values_1.default.applyDefaultValuesForElements(this.elements, record.formValues, record);
        return record;
    }
    get statusField() {
        if (!this._statusField) {
            this._statusField = new status_element_1.default(this, this._statusFieldJSON);
        }
        return this._statusField;
    }
    get projectField() {
        if (!this._projectField && this._projectEnabled) {
            this._projectField = new project_element_1.default(this, {});
        }
...
child_elements_1.default.includeInto(Form);
